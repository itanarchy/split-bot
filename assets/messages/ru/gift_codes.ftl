...
messages-gift_codes-not_found = 🎁 Подарочный код не найден
...
messages-gift_codes-shared =
    🎁 Подарочный код на { $total_amount } TON в звёздах

    Сумма активации: { $amount } TON
    Активаций осталось: { $activations_left } из { $max_activations }

buttons-share_gift_code = 🎁 Поделиться подарочным кодом
buttons-claim_gift_code = Получить звёзды
